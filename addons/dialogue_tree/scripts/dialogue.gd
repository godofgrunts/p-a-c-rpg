...
func _on_Dialogue_Choice_Next(ref, choices):
	SignalManager.emit_signal("dialogue_choice_next", ref, choices)


func _on_Dialogue_Conditonal_Data_Needed():
	SignalManager.emit_signal("dialogue_conditional_data_needed")


func _on_Dialogue_Dialogue_Ended():
	SignalManager.emit_signal("dialogue_dialogue_ended")


func _on_Dialogue_Dialogue_Next(ref, actor, text):
	print("next")
	SignalManager.emit_signal("dialogue_dialogue_next", ref, actor, text)


func _on_Dialogue_Dialogue_Started():
	print("Started")
	SignalManager.emit_signal("dialogue_dialogue_started")

func _connect_signals():
# warning-ignore:unused_signal
	SignalManager.connect("start_dialogue_scene", self, "start_dialogue")
# warning-ignore:return_value_discarded
	self.connect("Choice_Next", self, "_on_Dialogue_Choice_Next")
# warning-ignore:return_value_discarded
	self.connect("Conditonal_Data_Needed", self, "_on_Dialogue_Conditonal_Data_Needed")
# warning-ignore:return_value_discarded
	self.connect("Dialogue_Ended", self, "_on_Dialogue_Dialogue_Ended")
# warning-ignore:return_value_discarded
	self.connect("Dialogue_Next", self, "_on_Dialogue_Dialogue_Next")
# warning-ignore:return_value_discarded
	self.connect("Dialogue_Started", self, "_on_Dialogue_Dialogue_Started")